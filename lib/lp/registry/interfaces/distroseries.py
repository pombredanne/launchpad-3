    ...
    split_long_descriptions = exported(
        Bool(
            ...
            description=_("""
                ...
                across architectures rather than to the per-architecture
                Packages files. This reduces the bandwidth footprint of
                enabling multiarch on clients, which requires downloading
                Packages files for multiple architectures.""")))
