...
from lp.registry.mail.notifications import send_direct_contact_email
...
class SendDirectContactEmailTestCase(TestCaseWithFactory):
    ...
    def test_send_success(self):
        ...
        self.assertEqual('me@eg.dom', notification['From'])
        self.assertEqual('him@eg.dom', notification['To'])
