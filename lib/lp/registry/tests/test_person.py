...
class TestPerson(TestCaseWithFactory):
    ...
    def test_getBranchVisibilityInfo_empty_branch_names(self):
        ...
        info = person.getBranchVisibilityInfo(person, branch_names=[])
    ...
    def test_getBranchVisibilityInfo(self):
        ...
        login_person(owner)
        info = person.getBranchVisibilityInfo(owner, branch_names=branches)
        self.assertEqual('Fred', info['person_name'])
    ...
    def test_getBranchVisibilityInfo_unauthorised_user(self):
        ...
        info = person.getBranchVisibilityInfo(someone, branch_names=branches)
    ...
    def test_getBranchVisibilityInfo_anonymous(self):
        ...
        login_person(owner)
        info = person.getBranchVisibilityInfo(None, branch_names=branches)
        self.assertEqual({}, info)
