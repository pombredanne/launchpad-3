...
YUI.add('registry.product-views', function (Y) {
     ...
     * @param {String} value
     */
    var bind_information_type = function (view, value) {
        debugger;
        ...
        widget.on('save', function (ev) {
            information_type_change(ev.target.get('value'));
        });

        // If we don't have a value to start with, always default to PUBLIC.
        if (value) {
            information_type_change(value);
        } else {
            information_type_change('PUBLIC');
        }
     ...
     *
     * @function information_type_change
     * @param {String} information_type value
     */
    var information_type_change = function (value) {
     ...
     *
     * @class registry.views.EditProject
     * @extends Y.View
     *
     */
    ns.EditProject = Y.Base.create('edit-project-view', Y.View, [], {
        /**
