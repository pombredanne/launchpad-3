    ...
    ns.NewProduct = Y.Base.create('new-product-view', Y.Base, [], {
        ...
        _bind_information_type: function () {
            ...
            Y.lp.app.choice.addPopupChoiceForRadioButtons(
                'information_type',
                Y.lp.app.information_type.information_type_to_choicesource(
                    LP.cache.information_type_data));

            // When the information type changes, check if we should show/hide
            // UI components.
            Y.one('input[name="field.information_type"]').on('change', function (ev) {
                console.log('Change in the info type field');
                that.fire('information_type:changed', {
                    input: ev.target
                });
            });
        },
         ...
         *
         */
        _information_type_change: function (ev) {
            console.log('change detected yay');
            debugger;
        },
