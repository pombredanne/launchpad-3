...
function setup_overlay(content_box_id) {
    ...
    var control_code =
        ...
        '  <dd>' +
        '    <input type="radio" name="events" value="added-or-closed"' +
        '    checked>are added or closed<br>' +
        '    <input type="radio" name="events" value="added-or-changed">are' +
        '    added or changed in any way<br>' +
        '    <dl>' +
        '      <dt></dt>' +
        '      <dd>' +
        '        <input type="checkbox" name="filters"' +
        '               value="filter-out-comments">filter out comments<br>' +
        '        <input type="checkbox" name="filters" value="advanced-filter"' +
        '               checked>bugs must match this filter<br>' +
        '      </dd>' +
        '    </dl>' +
        '    </dd>' +
        '</dl>';
    ...
    var overlay_id = '#' + srcNode._node.id;
    container.appendChild(srcNode);
    var accordion = create_accordion(overlay_id);
