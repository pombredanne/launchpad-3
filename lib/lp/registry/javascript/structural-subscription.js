    ...
    return function() {
        var y_config = {
            ...
            on: {success: function(transactionid, response, args){
                    ...
                    collapse_node(to_collapse, { remove_on_end: true });
                 },
...
function make_subscription_add_success_handler(config) {
...
function show_add_overlay(config) {
    ...
    var success_callback = make_subscription_add_success_handler(config);
