...
//    // HACKY HACKY HACKY
//    Y.extend(Y.lazr.FormOverlay, Y.lazr.PrettyOverlay, {
//        renderUI: function() {
//            //This will call the parent objects renderUI method
//            Y.lazr.FormOverlay.superclass.hide.apply(
//                this, arguments);
//            Y.log('dingledangle');
//        }
//    });
...
function setup_client() {
    if (!Y.Lang.isValue(namespace.lp_client)) {
