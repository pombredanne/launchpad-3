...
// have text-overflow and the title is too wide, add ellipsis.
...
function create_overlay(content_box_id, overlay_id, submit_button,
    ...
    if (using_ellipsis_hack) {
        console.log('here 1');
        console.log('sw: '+header.get('scrollWidth'));
        console.log('ow: '+header.get('offsetWidth'));
