...
function extract_form_data(form_data) {
    ...
    // Extract the tags, importances, and statuses.
...
function make_edit_handler(filter_info, filter_id, subscriber_is_team,
    ...
    return function(e) {
        ...
        if (add_subscription_overlay) {
            ...
            collapse_node(accordion_node, {duration: 0}); // Hide usually.
            if (event == ADDED_OR_CHANGED) {
                // Show the filters section.
                expand_node(filter_node, {duration: 0});
                if (has_advanced_filters) {
                    // Show the accordion.
                    expand_node(accordion_node, {duration: 0});
                }
            } else {
                collapse_node(filter_node, {duration: 0});
            }
