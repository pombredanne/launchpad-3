...
function make_cell(s, name) {
    return '<td><label><input type="checkbox" name="' + name +'" '+
...
function setup_overlay(content_box_id) {
    ...
    var control_code =
        ...
        '        class="sprite maybe">&nbsp;<span class="invisible-link">Structural subscription description help</span></a>\n ' +
        '  </dd>\n' +
...
function events_state_handler() {
    var ctl = Y.one("#events_add_or_change");
