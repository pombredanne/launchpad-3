   ...
   var testArchitecturesChoiceListWidget = {
    ...
    var testPackagesetPickerWidget = {
        ...
        testAddPackagesets: function() {
            ...
            this.widget.add_packagesets(package_sets_collection, distroseries);
        ...
        testAddDistroSeriesInitiatesIO: function() {
            ...
            var distroseries = {value: "4", title: "series1", api_uri: "ubuntu/hoary"};
            this.widget.add_distroseries(distroseries);
            Assert.isTrue(io, "No IO initiated.");
        },
    ...
    var small_suite = new Y.Test.Suite("distroseries.initseries Tests");
    small_suite.add(new Y.Test.Case(testParentSeriesListWidget));
    Y.Test.Runner.add(small_suite);
