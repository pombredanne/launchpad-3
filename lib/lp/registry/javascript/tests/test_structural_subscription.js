...
YUI().use('lp.testing.runner', 'lp.testing.helpers', 'test', 'console',
    ...
    function remove_test_node() {
        ...
        var error_overlay = Y.one('.yui3-lp-ui-formoverlay');
    ...
    test_case = new Y.Test.Case({
        ...
        test_overlay_error_handling_adding: function() {
            ...
            overlay = Y.one('#accordion-overlay');
            Assert.isNotNull(overlay);
            submit_button = Y.one('.yui3-lp-ui-formoverlay-actions button');
            submit_button.simulate('click');

            var error_box = Y.one('.yui3-lp-ui-formoverlay-errors');
            Assert.areEqual(
    ...
    suite.add(new Y.Test.Case({
        ...
        test_simple_add_workflow: function() {
            ...
            var button = Y.one('.yui3-lp-ui-formoverlay-actions button');
        ...
        test_simple_add_workflow_canceled: function() {
            ...
            Assert.isFalse(module.lp_client.patch_called);
            var button = Y.one(
                '.yui3-lp-ui-formoverlay-actions button+button');
    ...
    suite.add(new Y.Test.Case({
        ...
        test_title: function() {
            ...
            // Click the edit link.
            Y.one('a.edit-subscription').simulate('click');
            var overlays = Y.all('.yui3-lp-ui-formoverlay');
            ...
            Y.one('a.edit-subscription').simulate('click');
            overlays = Y.all('.yui3-lp-ui-formoverlay');
