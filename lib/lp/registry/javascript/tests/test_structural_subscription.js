...
YUI({
    ...
    test_case = new Y.Test.Case({
        ...
        setUp: function() {
            ...
            this.content_node = Y.Node.create(
                '<div id="test_content">' +
        ...
        xtest_anonymous: function() {
            ...
            Assert.isFalse(module.is_ready);
        ...
        test_logged_in_user: function() {
            Y.log('test_logged_in_user');
            Y.log(this.configuration);
            LP.links.me = 'https://launchpad.dev/api/~someone';
            Assert.isUndefined(module.lp_client);
            Assert.isFalse(module.is_ready);
            module.setup(this.configuration);
            Assert.isTrue(module.is_ready);
            Assert.isNotUndefined(module.lp_client);
        },

        xtest_list_contains: function() {
            var list = ['a', 'b', 'c'];
