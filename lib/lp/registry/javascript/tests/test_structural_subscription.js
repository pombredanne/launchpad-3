...
YUI({
    ...
    suite.add(new Y.Test.Case({
        ...
        test_delete_on_patch_failure: function() {
            ...
            // Next we need to inject our own failure handler.
            var original_failure_handler = module._failure_handler;
            var failure_handler_called = false;
            module._failure_handler = function() {
            ...
            module._failure_handler = original_failure_handler;

            // Delete should have been called and the failure handler.
            Assert.isTrue(delete_called);
            Assert.isTrue(failure_handler_called);
        },
