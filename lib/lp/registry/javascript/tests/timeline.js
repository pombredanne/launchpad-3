...
YUI({
    ...
    combine: false,
    fetchCSS: false
    }).use('test', 'console', 'lp.registry.timeline', function(Y) {
...
// XXX sinzui 2011-06-07: This test requires a running server
// to pass the browser's unsafe js frame access rules.
//suite.add(new Y.Test.Case({
