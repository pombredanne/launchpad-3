    ...
    var shared = {
        ...
        assert_license_updates: function () {
            ...
            Y.Assert.areEqual('none',
                              ...
                              'License is hidden when PROPRIETARY is ' +
                              'selected.');
    ...
    tests.suite.add(new Y.Test.Case({
        ...
        test_information_type_choose_non_public: function () {
            ...
            Y.Assert.areNotEqual(
                ...
                'Bug Supervisor is shown when PROPRIETARY is selected.');
            ...
            Y.Assert.areNotEqual(
                ...
                'Driver is shown when PROPRIETARY is selected.');
        }
    }));
