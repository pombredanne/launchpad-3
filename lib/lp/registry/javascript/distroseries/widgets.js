...
Y.extend(ArchitecturesChoiceListWidget, formwidgets.ChoiceListWidget, {
    ...
    remove_distroseries: function(distroseries_id) {
        ...
        this._remove_archs(arch_to_remove);
        if (this.fieldNode.all('input').isEmpty()) {
            this.clean_display();
        }
    },

    _remove_archs: function(arch_to_remove) {
        this.remove_choices(arch_to_remove);
        this.fire("removed_archs", this, arch_to_remove);
    },

    _add_archs: function(distroseries_id, arch_to_add) {
        this.add_choices(arch_to_add);
        this.fire("added_archs", this, arch_to_add);
    },
    ...
    add_distroarchseries: function(distroseries_id, distroarchseries) {
        ...
        this._add_archs(distroseries_id, choices);
     }
