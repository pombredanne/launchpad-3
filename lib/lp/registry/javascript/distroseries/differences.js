...
var connect_last_changed_picker = function(origin, form) {
    ...
    var config = {
        ...
        headerContent: "<h2>Select person or team</h2>",
        // form_content: picker_table,
        // form_submit_button: submit_button,
        // form_cancel_button: cancel_button,
        // form_submit_callback: submit_callback,
    ...
    var picker = new Y.lp.app.picker.create(
        "ValidPersonOrTeam", config, input.generateID);
    linkify(origin).on("click", function() { picker.show(); });

    // XXX For development only.
    window.picker = picker;
    window.picker_input = input;
};
