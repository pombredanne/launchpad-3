...
Y.extend(SharingDetailsView, Y.Widget, {
    ...
    renderUI: function() {
        ...
        var details_table = new ns.SharingDetailsTable({
            ...
            person_uri: LP.cache.sharee.self_link,
            person_name: LP.cache.sharee.displayname,
            pillar_uri: LP.cache.pillar.self_link,
        ...
        sharing_details_table.subscribe(
            ns.SharingDetailsTable.REMOVE_GRANT, function(e) {
                self.confirm_grant_removal(
                    ...
                    e.details[3], e.details[4], e.details[5]);
        });
    },
     ...
     */
    confirm_grant_removal: function(delete_link, person_uri, person_name,
        pillar_uri, artifact_uri, artifact_name) {
        ...
        var co = new Y.lp.app.confirmationoverlay.ConfirmationOverlay({
            submit_fn: function() {
                self.perform_remove_grant(
                    delete_link, person_uri, pillar_uri, artifact_uri);
            },
     ...
     * @param artifact_uri
     */
    perform_remove_grant: function(delete_link, person_uri, pillar_uri,
                                   artifact_uri) {
