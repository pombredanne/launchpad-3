        ...
        test_bug_revoke_click: function() {
            ...
            this.details_widget.subscribe(
                ...
                function(e) {
                    ...
                    var person_uri = e.details[1];
                    var person_name = e.details[2];
                    var pillar_uri = e.details[3];
                    var artifact_uri = e.details[4];
                    var artifact_name = e.details[5];
                    Y.Assert.areEqual('~fred', person_uri);
                    Y.Assert.areEqual('Fred', person_name);
                    Y.Assert.areEqual('/pillar', pillar_uri);
