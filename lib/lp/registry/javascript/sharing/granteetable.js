...
var
    ...
    // Events
    UPDATE_SHAREE = 'updateGrantee',
    UPDATE_PERMISSION = 'updatePermission',
    REMOVE_SHAREE = 'removeGrantee';
...
Y.extend(GranteeTableWidget, Y.Widget, {
    ...
    bindUI: function() {
        ...
        grantee_table.delegate('click', function(e) {
            ...
            self.fire(REMOVE_SHAREE, delete_link, grantee_link, person_name);
        }, 'span[id^=remove-] a');
        grantee_table.delegate('click', function(e) {
            e.halt();
            ...
            self.fire(UPDATE_SHAREE, update_link, grantee_link, person_name);
        }, 'span[id^=update-] a');
    },
...
GranteeTableWidget.UPDATE_SHAREE = UPDATE_SHAREE;
GranteeTableWidget.UPDATE_PERMISSION = UPDATE_PERMISSION;
GranteeTableWidget.REMOVE_SHAREE = REMOVE_SHAREE;
