    ...
    widget.all("td input[name=field.subscriptionpolicy]")
        ...
        if (visibility === 'PRIVATE') {
            if (policy_value === 'RESTRICTED') {
                ...
                input_row.addClass('unseen');
                help_row.addClass('unseen');
            }
        } else {
            input_row.removeClass('unseen');
            help_row.removeClass('unseen');
        }
    });
 ...
 * @param visibility
 */
module.visibility_changed_visbility = function(visibility) {
...
module.visibility_changed = function(visibility) {
    ...
    module.visibility_changed_visbility(visibility);
};
