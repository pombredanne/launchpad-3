...
namespace.setup_expandable_rows = function() {
     ...
     *
     * This method is responsible for adding the comment via the API and
     * updating the UI.
     *
    ...
    var add_comment_handler = function(comment_form, api_uri) {
        ...
        var success_handler = function(comment_entry) {
            ...
            config = {
                on: {
                    success: function(comment_html) {
                        ...
                        comment_form.insert(comment_node, 'after');
            ...
            // Get the comment fields to slide in again, as if the user
            // clicked on the 'Add comment' link and clear the comment field.
            Y.Event.simulate(
                Y.Node.getDOMNode(
                    comment_form.one('a.widget-hd')), 'click');
     ...
     *
     * This method is responsible for adding the markup for a slide-out
     * comment and setting up the event handlers.
     *
