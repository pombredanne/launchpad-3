...
suite.add(new Y.Test.Case({
    ...
    test_createSectionNode: function() {
        ...
        Y.Assert.isTrue(section_node.hasClass('subscribers-section-details'));
    ...
    test_insertSectionNode_before: function() {
        ...
        // Sections we'll be inserting in the order they should end up in.
        var section_node1 = subscribers_list._createSectionNode('Details');
        var section_node2 = subscribers_list._createSectionNode('Comments');

        subscribers_list._insertSectionNode('Comments', section_node2);
        Y.ArrayAssert.itemsAreEqual(
            [section_node2],
            _getAllSections(subscribers_list));

        // Details section comes in front of the 'Comments' section.
        subscribers_list._insertSectionNode('Details', section_node1);
        Y.ArrayAssert.itemsAreEqual(
...
suite.add(new Y.Test.Case({
    ...
    test_removeSectionIfEmpty_keeps_others: function() {
        ...
        var section_node2 = subscribers_list.getOrCreateSection('Comments');
