...
suite.add(new Y.Test.Case({
    ...
    tearDown: function() {
        if (Y.Lang.isValue(this.listing_util)) {
            this.listing_util.destroy();
        }
    },
    ...
    test_bug_listing_util_extends_base_util: function() {
        ...
        this.listing_util = new Y.lp.buglisting_utils.BugListingConfigUtil();
        Assert.isInstanceOf(Y.lp.configutils.BaseConfigUtil, this.listing_util);
    },
    ...
    test_default_display_keys: function() {
        ...
        var actual = this.getClassesAndNames(
            this.listing_util.get('display_keys'));
    ...
    test_default_field_visibility_config: function() {
        ...
        ObjectAssert.areEqual(
            expected_config, this.listing_util.get('field_visibility'));
    },
