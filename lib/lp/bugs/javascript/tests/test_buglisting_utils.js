...
suite.add(new Y.Test.Case({
    ...
    test_default_field_visibility_config: function() {
        ...
        var field_visibility_defaults = this.list_util.get('model').get(
            'field_visibility_defaults');
    ...
    test_field_visibility_defaults_readonly: function() {
        ...
        this.list_util.get('model').set('field_visibility_defaults', attempted_defaults);
    ...
    test_supplied_field_visibility_config: function() {
        ...
        this.list_util.render();
        ObjectAssert.areEqual(
            expected_config, this.list_util.get('model').get_field_visibility());
    },
    ...
    test_field_visibility_form_update_config: function() {
        ...
        var actual_config = this.list_util.get_model().get_field_visibility();
    ...
    test_fields_visibility_form_reset: function() {
        ...
        Y.on('buglisting-config-util:fields-changed', function(e) {
            ...
            var defaults = this.list_util.get('model').field_visibility_defaults;
            var fields = this.list_util.get('model').get_field_visibility();
