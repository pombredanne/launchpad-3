...
suite.add(new Y.Test.Case({
    ...
    test_bug_listing_util_extends_base_util: function() {
        ...
        var listing_util = new Y.lp.buglisting_utils.BugListingConfigUtil();
        Assert.isInstanceOf(Y.lp.configutils.BaseConfigUtil, listing_util);
    },
    ...
    test_default_display_config: function() {
        ...
        ObjectAssert.areEqual(
            expected_config, listing_util.get('field_visibility'));
    }
