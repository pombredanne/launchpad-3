...
suite.add(new Y.Test.Case({
    ...
    test_field_visibility_form_shows_defaults: function() {
        ...
        var inputs = Y.all('.yui3-formoverlay-content form input');
        var all_are_checkbox = true;
        var expected_names = [
            'show_bugtarget',
            'show_bug_heat',
            'show_id',
