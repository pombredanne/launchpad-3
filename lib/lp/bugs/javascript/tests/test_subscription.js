...
suite.add(new Y.Test.Case({
    ...
    _should: {
        error: {
            test_unsubscribe_duplicates_multiple_teams_fails:
    ...
    test_unsubscribe_duplicates_yourself_single_bug: function() {
    ...
    test_unsubscribe_duplicates_yourself_multiple_bug: function() {
        // There is a single duplicate bug you are subscribed to.
    ...
    test_unsubscribe_duplicates_team_single_bug: function() {
        // There is a single duplicate bug you are subscribed to.
        var args = { bugs: [ { self: { self_link: 'http://bug/' } } ],
    ...
    test_unsubscribe_duplicates_team_multiple_bug: function() {
        // There is a single duplicate bug you are subscribed to.
        var args = { bugs: [ { self: { self_link: 'http://bug1/' } },
                             { self: { self_link: 'http://bug2/' } }],
                     teams: [ { self: { self_link: 'http://team/' } } ] };
    ...
    test_unsubscribe_duplicates_multiple_teams_fails: function() {
        // There is a single duplicate bug you are subscribed to.
        var args = { bugs: [ { self: { self_link: 'http://bug/' } } ],
