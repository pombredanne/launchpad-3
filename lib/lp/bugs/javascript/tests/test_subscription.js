 ...
 * and test_bugtask_index_subscription_portlet.js).  It should be pushed to a
 * shared test module.  
 */
function LPClient(){
    ...
    test_fail: function() {
        ...
        this.wait(
            function () {
                ...
                Y.Assert.areEqual(
                    "The following errors were encountered: Oopsie!",
                    error_box.get('text'));
            }, 1100);
    }
