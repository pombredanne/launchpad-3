...
suite.add(new Y.Test.Case({
    ...
    _constructCategory: function(personal, as_member, as_admin) {
    ...
    test_multiple_direct_subscriptions: function() {
        ...
        var info = {
            direct: this._constructCategory(['1', '2']),
            count: 2
        };
    ...
    test_no_subscriptions: function() {
        ...
        var info = {
            direct: this._constructCategory(),
            from_duplicates: this._constructCategory()
        };
    ...
    test_no_direct_subscriptions: function() {
        // There is no direct subscription.  We get 'null' back.
        var info = {
            direct: this._constructCategory(),
            from_duplicates: this._constructCategory(['dupe'])
        };
        info.count = info.direct.count + info.from_duplicates.count;
        Y.Assert.areSame(
            null,
    ...
    test_muted_subscription: function() {
        ...
        var info = {
            direct: this._constructCategory(['direct']),
            muted: true,
        };
    ...
    test_direct_subscription: function() {
        ...
        var info = {
            direct: this._constructCategory([sub]),
            count: 1
        };
