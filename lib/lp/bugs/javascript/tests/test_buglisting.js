...
suite.add(new Y.Test.Case({
    ...
    test_render_disables_backwards_navigation_if_no_prev: function() {
        var navigator = this.get_render_navigator();
        var action = navigator.backwards_navigation.item(0);
        navigator.render();
        Y.Assert.isTrue(action.hasClass('inactive'));
    },
    test_render_enables_backwards_navigation_if_prev: function() {
        var navigator = this.get_render_navigator();
        var action = navigator.backwards_navigation.item(0);
    ...
    test_render_disables_forwards_navigation_if_no_next: function() {
        var navigator = this.get_render_navigator();
        var action = navigator.forwards_navigation.item(0);
        navigator.render();
        Y.Assert.isTrue(action.hasClass('inactive'));
    },
    test_render_enables_forwards_navigation_if_next: function() {
        var navigator = this.get_render_navigator();
        var action = navigator.forwards_navigation.item(0);
        action.addClass('inactive');
