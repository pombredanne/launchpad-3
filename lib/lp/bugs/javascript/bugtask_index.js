...
namespace.setup_bugtask_row = function(conf) {
    ...
    var delete_content = tr.one('.delete-content');
    ...
    if (Y.Lang.isValue(delete_content) && conf.user_can_delete) {
        delete_content.one('a').on('click', (function (e) {
            // e.preventDefault();
            //todo - add delete stuff here
        }));
    }
