...
var update_subscription_portlet = function() {
    var portal_node = Y.one('#portlet-subscription .section');
    var sub_link = portal_node.one('a.menu-link-subscription');
    sub_link.replaceClass('edit', 'spinner');

    var error_handler = new Y.lp.client.ErrorHandler();
    error_handler.clearProgressUI = function () {
        sub_link.replaceClass('spinner', 'edit');
    };
    error_handler.showError = function (error_msg) {
        Y.lp.anim.red_flash({node: portal_node}).run();
    };
    var config = {
        on: {
            success: function (id, response) {
                ...
                Y.lp.bugs.bugtask_index.portlets.subscription.update_subscription_status();
            },
    ...
    var submit_url = base_url+"/+portlet-subscription-details";
