...
function gather_subscriptions_as_supervisor(category) {
    ...
    for (index in category.personal) {
    ...
    for (index in category.as_team_member) {
    ...
    for (index in category.as_team_admin) {
