 ...
 *
 * The link will be constructed to have an icon followed by text with it all part of the <a> link.
 *
 * @param {Object} text Text of the link to be created.
 * @param {Object} sprite_class Name of the sprite to use for an icon.
 * @param {Object} method_name API method to call on the bug_link when the link is clicked.
                ...
                on: {success:
                        function (maybe_sub) {
                            ...
                            reveal_direct_description_actions(
                                Y.one('#direct-subscription'), info);
                         },
                     failure: handler.getFailureHandler()
                    },
...
function get_direct_description_node(info) {
    ...
    reveal_direct_description_actions(direct_node, info);
    return direct_node;
}
namespace._get_direct_description_node = get_direct_description_node;

function reveal_direct_description_actions(direct_node, info) {
    var i;
