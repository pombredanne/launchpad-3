...
YUI.add('lp.bugs.bugtracker_overlay', function(Y) {
    ...
    var save_new_bugtracker = function(data) {
        ...
        var finish_new_bugtracker = function(ignore) {
    ...
    show_bugtracker_form = function(e) {
        if (bugtracker_form) {
            bugtracker_form.show();
        } else {
