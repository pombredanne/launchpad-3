        ...
        result.on('click', function (e) {
            ...
            if (method_name === 'unsubscribe') {
                var private_bug_warning_node = Y.Node.create(
                    ['<div><p>You will not have access to this bug or any ',
                    'of its pages if you unsubscribe. If you want to stop ',
                    'emails, choose the "Mute bug mail" option.</p>',
