...
namespace.ListingNavigator = function(current_url, cache, template, target,
    ...
    namespace.ListingNavigator.superclass.constructor.apply(this, [config]);
};
...
Y.extend(namespace.ListingNavigator, Y.Base, {
    initializer: function(config){
        ...
        this.search_params = namespace.get_query(config.current_url);
        ...
        this.io_provider = config.io_provider;
        this.current_batch = lp_client.wrap_resource(null, config.cache);
