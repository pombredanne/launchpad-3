...
namespace.ListingNavigator = function(current_url, cache, template, target,
    ...
    this.target = target;
    this.batches = {};
    this.next_memo = cache.next_memo;
    this.prev_memo = cache.prev_memo;
};


namespace.ListingNavigator.prototype.clickAction = function(selector, callback){
    that = this;
...
namespace.ListingNavigator.prototype.next_batch = function(order_by){
    this.load_model({forward: true, memo: this.next_memo});
};

namespace.ListingNavigator.prototype.prev_batch = function(order_by){
    this.load_model({forward: false, memo: this.prev_memo});
};
