...
namespace.ListingNavigator = function(current_url, cache, template, target,
    ...
    this.clean_batch(this.current_batch);
...
namespace.ListingNavigator.prototype.clean_batch = function(batch){
    var key, i;
...
namespace.ListingNavigator.prototype.set_field_visibility = function(config){
