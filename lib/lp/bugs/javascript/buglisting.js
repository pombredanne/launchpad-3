...
Y.extend(namespace.ListingNavigator, Y.Base, {
    initializer: function(config){
        ...
        this.set(
            'current_batch', lp_client.wrap_resource(null, config.cache));
        this.field_visibility = this.get('current_batch').field_visibility;
        this.batches = {};
        this.handle_new_batch(this.get('current_batch'));
    ...
    render: function(){
        var model = Y.merge(
            this.get('current_batch').mustache_model, this.field_visibility);
