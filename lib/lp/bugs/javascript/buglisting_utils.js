...
YUI().add('lp.buglisting_utils', function(Y) {
    ...
    function BugListingModel(){
        BugListingModel.superclass.constructor.apply(this, arguments);
    }
    BugListingModel.NAME = 'buglisting-model';

    BugListingModel.ATTRS = {
        /**
    ...
    Y.extend(BugListingModel, Y.Base, {
        initializer: function(config){
            this.set('history', new Y.History({
                initialState: config.field_visibility
            }));
            this.set('field_visibility_names', config.field_visibility);
        },
    ...
    Y.extend(BugListingConfigUtil, Y.lp.configutils.BaseConfigUtil, {
        ...
        initializer: function(config){
            ...
            this.set('model', new BugListingModel(config));
        },
        ...
        addListeners: function() {
            ...
            this.get('model').get('history').after('change', function(e) {
...
}, '0.1', {'requires': ['history', 'lp.configutils', 'lazr.formoverlay']});
