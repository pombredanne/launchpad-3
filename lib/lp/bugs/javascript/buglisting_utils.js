...
YUI().add('lp.buglisting_utils', function(Y) {
    ...
    Y.extend(BugListingModel, Y.Base, {
        get_field_visibility: function(){
            return this.get('field_visibility');
        },
        set_field_visibility: function(value){
            return this.set('field_visibility', value);
        }
    });
    ...
    Y.extend(BugListingConfigUtil, Y.lp.configutils.BaseConfigUtil, {
        ...
        addListeners: function() {
            ...
            this.get('model').after('field_visibilityChange', function(e) {
        ...
        handleOverlaySubmit: function(data) {
            var fields = this.get('model').get('field_visibility_defaults');
            var member;
