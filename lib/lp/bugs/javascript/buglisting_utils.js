...
YUI().add('lp.buglisting_utils', function(Y) {
    ...
    Y.extend(BugListingConfigUtil, Y.lp.configutils.BaseConfigUtil, {
         ...
         *
         * @method _getResetLink
         */
        _getResetLink: function() {
         ...
         *
         * We do these as a global event rather than listing for
        ...
        _handleOverlaySubmit: function(data) {
            var fields = Y.clone(this.constructor._field_visibility_defaults);
        ...
        _extraRenderUI: function() {
            var form_content = this._buildFormContent();
