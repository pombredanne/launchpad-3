...
YUI().add('lp.buglisting_utils', function(Y) {
    ...
    function update_sort_button_visibility(orderbybar, data_visibility) {
        ...
        var display_to_orderby = [
            ['show_datecreated', 'datecreated'],
            ['show_title', 'title'],
            ['show_assignee', 'assignee'],
            ['show_heat', 'heat'],
            ['show_targetname', 'targetname'],
            ['show_id', 'id'],
            ['show_importance', 'importance'],
            ['show_date_last_updated', 'date_last_updated'],
            ['show_milestone_name', 'milestone_name'],
            ['show_reporter', 'reporter'],
            ['show_status', 'status'],
            ['show_tag', 'tag']
        ];
        var len = display_to_orderby.length;
        var i;
        var orderby_visibility = {};
        for (i = 0; i < len; i++) {
            var display_flag = display_to_orderby[i][0];
            var orderby_name = display_to_orderby[i][1];
            orderby_visibility[orderby_name] = data_visibility[display_flag];
        }
