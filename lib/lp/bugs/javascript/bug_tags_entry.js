...
namespace.setup_tag_entry = function(available_official_tags) {
    ...
    namespace.setup_tag_completer('#tag-input', available_official_tags);
};
 ...
 */
namespace.setup_tag_completer = function(input, available_official_tags) {
    Y.one(input).ancestor('div').append(
