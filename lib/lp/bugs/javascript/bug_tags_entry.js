...
namespace.update_ui = function() {
    // XXX sinzui 2012-06-22: this is shim to support the new markup.
    tags_heading = Y.one('#tags-heading');
    tags_trigger = Y.one('#tags-trigger');
    tag_list_span = Y.one('#tag-list');
    if (Y.Lang.trim(tag_list_span.get('innerHTML')) === '') {
