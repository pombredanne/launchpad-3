...
var convertTextInputToTextArea = function(current_text_input, rows) {
    var new_text_area = Y.Node.create("<textarea></textarea>")
            ...
            .set('rows', rows);
    var changee = Y.Event.getListeners(current_text_input, 'change');
    Y.log(current_text_input.get('onchange'))
    new_text_area.on('change', Y.Event.getListeners(
        current_text_input, 'change'));
    new_text_area.on('keypress', Y.Event.getListeners(
        current_text_input, 'keypress'));
