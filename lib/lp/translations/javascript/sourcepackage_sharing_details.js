...
Y.extend(TranslationSharingController, Y.Base, {
    ...
    replace_product: function(product){
        ...
        this.set_translations_usage(product.get('translations_usage'))
    },
...
namespace.prepare = function(cache){
    ...
    sharing_controller.set('branch_picker_config', config);
    ...
    var import_url = sharing_controller.get('productseries').get('web_link');
    import_url = Y.lp.get_pathname(import_url)
