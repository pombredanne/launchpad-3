...
namespace.add_doubleclick_handler = function() {
    ...
    handler = function(e) {
        ...
        var line_number = e.currentTarget.one('.line-no').get('text');
        // Retrieve or create a container for the comment editor.
        var draft_div = Y.one(
            '#' + e.currentTarget.get('id') + '-comments .draft');
        if (draft_div === null) {
...
namespace.create_row = function(comment) {
    ...
    var line_class = 'diff-line-' + comment.line_number;
