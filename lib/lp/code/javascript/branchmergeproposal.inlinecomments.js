...
namespace.add_doubleclick_handler = function(diff_timestamp) {
...
namespace.populate_existing_comments = function(diff_timestamp) {
...
namespace.setup_inline_comments = function(diff_timestamp) {
    if (LP.cache.inline_diff_comments === true) {
        ...
        namespace.add_doubleclick_handler(diff_timestamp);
        namespace.populate_existing_comments(diff_timestamp);
    }
};
