...
var confirm_reviewer = function(branch_info, picker, save_fn, cancel_fn) {
    var invisible_branches = branch_info.invisible_branches;
    if (Y.Lang.isValue(invisible_branches)) {
        ...
        var yesno_content_template = [
            ...
            "{person_name} does not currently have permission to view branches:",
            "<ul style='margin-left: 50px'></ul></p>",
            "<p>If you proceed, {person_name} will be subscribed to the branches.</p>",
...
var check_reviewer_can_see_branches = function(picker, value, save_fn, cancel_fn) {
    ...
    var confirm = function(branch_info) {
        confirm_reviewer(branch_info, picker, save_fn, cancel_fn);
    };
    ...
    lp_client.named_get(reviewer_uri, "getBranchVisibilityInfo", y_config);
};
...
}, "0.1", {"requires": ["io", "dom", "node", "event", "lp.client"]});
