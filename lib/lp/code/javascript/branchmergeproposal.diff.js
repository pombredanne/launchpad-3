...
//          // Maybe there's a nicer way to get the icon from the
//          // widget itself -- i.e. this.get('cancel_icon') ?
//          // Look at Overlay and PrettyOverlay to see.
//          // if not, get it directly:
            var cancel_icon = Y.one('.close-button');

            // We need a reference to the widget inside the event handler.
            var that = this;

          // Then setup a click handler to dismiss it.
