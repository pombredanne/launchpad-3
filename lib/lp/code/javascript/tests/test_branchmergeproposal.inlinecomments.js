...
YUI.add('lp.code.branchmergeproposal.inlinecomments.test', function (Y) {
    ...
    tests.suite.add(new Y.Test.Case({
        ...
        /*
         * Test clicking link with no IC leaves publish unchecked and submit is disabled
         * Test clicking link with IC checks publish and submit is enabled

        test_click_publish_scroller_with_draft: function() {
            // Mimics a person object as stored in LP.cache (unwrap).
            var person_obj = {
                "display_name": "Foo Bar",
                "name": "name16",
