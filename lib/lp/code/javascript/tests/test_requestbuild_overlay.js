...
suite.add(new Y.Test.Case({
    ...
    test_requestbuilds_success: function() {
        ...
        Y.Assert.isTrue(
            Y.one(".yui3-lp-ui-formoverlay")
             .hasClass("yui3-lp-ui-formoverlay-hidden"));
        Y.Assert.areSame(
            2, Y.one("#builds-target").all('.package-build').size());
    },
    ...
    test_requestbuilds_failure_500: function() {
        ...
        Y.Assert.areSame(
            message,
            Y.one(".yui3-lp-ui-formoverlay-errors li").get('text'));
    ...
    test_requestbuilds_build_collision: function() {
        ...
        Y.Assert.areSame(
            ...
            Y.one(
                ".yui3-lp-ui-formoverlay-errors .popup-build-informational")
                .get('text'));
        // The error message is displayed.
        Y.Assert.areSame(
            error_message,
