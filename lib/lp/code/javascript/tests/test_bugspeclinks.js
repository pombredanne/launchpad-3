...
YUI({
    ...
    suite.add(new Y.Test.Case({
        ...
        test_leading_zeros_are_ignored: function() {
            // Since bug IDs can't start with zeros, any leading zero is
            // ignored.
            Y.Assert.isNull(extract_candidate_bug_id('foo-0001234-bar'));
        },
