...
YUI({
    ...
    suite.add(new Y.Test.Case({
        ...
        /*
         * bmpGetDiffUrl(revno) gets the URL for a diff of just that revision
         */
        test_bmpGetDiffUrl_one_arg: function() {
            Y.Assert.areEqual(
                'fake-link-base/1234',
                module.bmpGetDiffUrl('1234'));
            },

        /*
         * bmpGetDiffUrl(start_revno, end_revno) gets the URL for a diff of the
         * given revision range.
         */
        test_bmpGetDiffUrl_two_args: function() {
            Y.Assert.areEqual(
                'fake-link-base/33/22',
                module.bmpGetDiffUrl('22', '33'));
            },

        /*
         * bmpGetDiffUrl(0, 1) just returns URL_BASE/1, rather than URL_BASE/1/0
         * which Loggerhead will reject.
         */
        test_bmpGetDiffUrl_of_0_to_1: function() {
            Y.Assert.areEqual(
                'fake-link-base/1',
                module.bmpGetDiffUrl('0', '1'));
            },

        /*
         * bmpGetDiffUrl(0, 2) just returns URL_BASE/1, rather than URL_BASE/1/0
         * which Loggerhead will reject.
         */
        test_bmpGetDiffUrl_of_0_to_2: function() {
            Y.Assert.areEqual(
                'fake-link-base/2/XXX',
                module.bmpGetDiffUrl('0', '2'));
            },
        }));
