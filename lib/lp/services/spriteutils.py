...
# The default margin is 2 lines of h1 line-hieght + 50% for scaling
# (40 + 40 + 20). Block elements often have 3 lines so the value is trippled.
DEFAULT_INLINE = 100
DEFAULT_BLOCK = 300
...
class SpriteUtil:
    ...
    def __init__(self, css_template_file, group_name,
                 url_prefix_substitutions=None, margin=DEFAULT_INLINE):
