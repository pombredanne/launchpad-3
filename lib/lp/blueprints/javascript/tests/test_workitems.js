...
suite.add(new Y.Test.Case({
    ...
    test_setUpWorkItemExpanders: function() {
        ...
        Y.all('.collapsible-body').each(function(e) {
            ...
            // and clicked closed they get the classes lazr-closed and unseen.
            // This assert is more encapsulating in case this changes.
            Y.Assert.isTrue(e.hasClass('lazr-closed') || e.hasClass('lazr-open'));
        });
    },

    attach_ping_catcher: function(event){
        module._attach_handler(event, function(){module.test__ping_called = true});
    },
