...
suite.add(new Y.Test.Case({
        ...
        return {
            ...
            items: [
              { name: 'New', value: 'new', style: '',
                description: 'Something New', help: '', disabled: false },
              { name: 'Invalid', value: 'invalid', style: '',
                description: 'Something Invalid', help: '', disabled: true },
    ...
    test_choicesource_overrides_value_in_page: function() {
        ...
        // config.value
        Assert.areEqual("Incomplete", st.one(".value").get("text"),
                        "ChoiceSource is not overriding displayed value " +
                        "in HTML");
    },
    ...
    test_choicelist_has_correct_values: function() {
        ...
        Y.each(this.config.items, function(configitem) {
            ...
            Assert.isTrue(found,
              "Item " + configitem.name + " is passed to ChoiceSource but " +
              "is not in ChoiceList.items");
        });
        var choicelistcount =
