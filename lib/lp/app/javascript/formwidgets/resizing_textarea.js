...
Y.extend(ResizingTextarea, Y.Plugin.Base, {
    ...
    _run_change: function (new_value) {
        console.log('running change', new_value);
    ...
    _update_clone_width: function () {
        console.log('node', this.t_area.get('winWidth'));
        console.log('updating width', this.t_area.getComputedStyle('width'));
        console.log('width', this.t_area.get('width'));
        console.log('client width', this.t_area.get('clientWidth'));
