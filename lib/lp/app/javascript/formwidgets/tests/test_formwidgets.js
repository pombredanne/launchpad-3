...
YUI.add('lp.app.formwidgets.test', function(Y) {
    ...
    var testChoiceListWidget = {
        ...
        testChoiceWithRadio: function() {
            ...
            this.widget.fieldNode.one("input[value=a]")
                .set("checked", "checked");
            Assert.areSame("a", this.widget.get("choice"));
        ...
        testAddChoicesEvents: function() {
            /* Calling add_choices() causes choicesChange event to fire. */
            var event;
            this.widget.after("choicesChange", function(e) { event = e; });
            this.widget.add_choices(["a", "b"]);
            Assert.isObject(event);
        },

        testRemoveChoicesEvents: function() {
            /* Calling remove_choices() causes choicesChange event to fire. */
            var event;
            this.widget.add_choices(["a", "b"]);
            this.widget.after("choicesChange", function(e) { event = e; });
