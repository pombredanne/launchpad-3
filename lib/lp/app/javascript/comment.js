...
var update_comment = function (link, comment) {
...
var set_visibility = function (parameters, callbacks) {
...
var toggle_hidden = function (link) {
...
namespace.Comment = Y.Base.create('comment', Y.Widget, [], {
    ...
    bindUI: function(){
        ...
        comment_list_container.delegate('click', callback, 'a');
    },
    /**
