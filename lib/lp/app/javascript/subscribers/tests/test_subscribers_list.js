...
function setUpLoader(root_node, config, barebone) {
    ...
    if (barebone !== true) {
        container_config.context = { web_link: '/base', self_link: '/bug/1' };
...
suite.add(new Y.Test.Case({
    ...
    test_setupSubscribeSomeoneElse: function() {
        ...
        var old_method =
            module.SubscribersLoader.prototype._subscribeSomeoneElse;
        module.SubscribersLoader.prototype._subscribeSomeoneElse =
            function(person) {
    ...
    test_subscribeSomeoneElse_success: function() {
        ...
        // is called indicating success, and addUnsubscribeAction
        ...
        loader._subscribeSomeoneElse(person, 'Level1');
