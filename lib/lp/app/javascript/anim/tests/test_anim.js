...
YUI.add('lazr.anim.test', function(Y) {

var namespace = Y.namespace('lazr.anim.test');
...
var TestAnim = {
    ...
    test_resolveNodeListFrom_selector: function() {
        ...
        var nodelist = Y.lazr.anim.resolveNodeListFrom(selector);
    ...
    test_resolveNodeListFrom_node_list: function() {
        ...
        var nodelist = Y.lazr.anim.resolveNodeListFrom(nodelist_orig);
        Assert.isInstanceOf(Y.NodeList, nodelist);
...
namespace.suite = suite;
               ...
               'lp.testing.runner', 'test', 'console', 'node',
               'lazr.anim', 'event', 'event-simulate']});
