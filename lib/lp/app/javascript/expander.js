...
namespace.Expander.prototype = {
    ...
    foldContentNode: function (expand) {
        var anim;
        if (Y.Lang.isObject(this._animation)) {
            anim = this._animation;
            this._animation.stop();
            this._animation.set('reverse', !this._animation.get('reverse'));
        } else {
            if (expand) {
                anim = new Y.lazr.effects.slide_out(this.content_node);
            } else {
                anim = new Y.lazr.effects.slide_in(this.content_node);
            }
