 ...
 * sets a spinner and runs the loader.  The loader generates HTML and feeds it
 * to a callback function, which will enter the HTML into the content tag.
 *
 ...
 *     (so it matched css_selector), and a function that processes the HTML
 *     text to be entered into the content tag.
 */
