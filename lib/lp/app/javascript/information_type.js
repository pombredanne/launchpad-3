...
var get_information_type_banner_text = function(value) {
    ...
    var info_type = ns.information_type_value_from_key(value, 'name');
...
ns.information_type_save_success = function(widget, context, value,
    ...
    context.information_type =
        ns.information_type_value_from_key(value, 'name');
    debugger;
...
ns._confirm_information_type_change = function(widget, initial_value,
    ...
    var title = ns.information_type_value_from_key(value, 'name');
...
ns.setup_information_type_choice = function(privacy_link, lp_client,
    ...
    var initial_value = ns.information_type_value_from_key(
        context.information_type, 'value');
 ...
 * @return {*}
 */
ns.information_type_value_from_key = function(cache_key_value,
                                                     value_property_name) {
    var cache = LP.cache.information_type_data;
    var value;
    if (cache[cache_key_value]) {
        value = cache[cache_key_value][value_property_name];
    } else {
        value = false;
    }
    return value;
