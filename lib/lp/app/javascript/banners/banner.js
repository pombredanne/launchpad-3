...
ns.Banner = Y.Base.create('banner', Y.Widget, [], {
    ...
    renderUI: function () {
       ...
       var banner_html = Y.lp.mustache.to_html(
            ...
            banner_data);
       banner_node = Y.Node.create(banner_html);
       this.set('banner_node', banner_node);
       this.get('contentBox').appendChild(banner_node);
    },
    ...
    updateText: function (new_text) {
        ...
        var banner_node = this.get('banner_node');
        if (banner_node !== null) {
