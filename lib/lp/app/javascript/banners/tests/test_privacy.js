...
YUI().use('lp.testing.runner', 'test', 'console', 'node',
          'lp.app.banner.privacy', 'node-event-simulate', function(Y) {

    var suite = new Y.Test.Suite("lp.app.banner.privacy Tests");

    suite.add(new Y.Test.Case({
        name: 'privacy',

        _reset_container: function () {
            Y.lp.app.banner.privacy._reset_privacy_notification();
        ...
        test_setup: function() {
            ...
            Y.lp.app.banner.privacy.setup_privacy_notification(config);
        ...
        test_hide_removes_ribbon: function () {
            ...
            var ribbon = Y.one('.global-notification');
            Y.Assert.isFalse(ribbon.hasClass('hidden'));
            Y.lp.app.banner.privacy.hide_privacy_notification(false);
