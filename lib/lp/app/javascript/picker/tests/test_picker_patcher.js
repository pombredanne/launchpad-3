...
suite.add(new Y.Test.Case({
    ...
    test_privacy_warning: function () {
        ...
        // buttons are lost.
        var expected_text = "The team you are assigning to this role is " +
            "private; continuing will expose the existence of  this team." +
            "Do you wish to continue?YesChoose Again";
