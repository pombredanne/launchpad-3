...
Y.extend(Picker, Y.lazr.PrettyOverlay, {
    ...
    _syncSearchModeUI: function() {
        ...
        if (search_mode) {
            this.get('boundingBox').addClass(C_SEARCH_MODE);
        } else {
            this.get('boundingBox').removeClass(C_SEARCH_MODE);
    ...
    _syncErrorUI: function() {
        ...
        if (error === null) {
            this.get('boundingBox').removeClass(C_ERROR_MODE);
        } else {
            this._error_box.appendChild(document.createTextNode(error));
            this.get('boundingBox').addClass(C_ERROR_MODE);
        }
    },
