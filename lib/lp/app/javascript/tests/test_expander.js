...
YUI({
    ...
    suite.add(new Y.Test.Case({
        ...
        test_receive_stops_animation: function() {
            var expander = this.makeExpander();
            var animation_stopped = false;
            var fake_anim = {
                stop: function() { animation_stopped = true; },
                // get('running') returns true.
                get: function() { return true; },
                set: function() {},
                run: function() {} };
            expander._animation = fake_anim;
            expander.receive('');
            Y.Assert.isTrue(animation_stopped);
        }
    }));
