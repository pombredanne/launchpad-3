...
YUI.add('lp.app.information_type_choice.test', function (Y) {

    var tests = Y.namespace('lp.app.information_type_choice.test');
    var ns = Y.lp.app.information_type_choice;
    tests.suite = new Y.Test.Suite('lp.app.information_type_choice Tests');

    tests.suite.add(new Y.Test.Case({
        name: 'lp.app.information_type_choice_tests',
        ...
        test_library_exists: function () {
            Y.Assert.isObject(Y.lp.app.information_type_choice,
                "Cannot locate the lp.app.information_type_choice module");
        },
