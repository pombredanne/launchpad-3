...
var TestModel = function(){
    TestModel.superclass.constructor.apply(this, arguments);
}

TestModel.ATTRS = {
    batch_key: {value: null},
    field_visibility: {value: null},
...
var TestListingNavigator = function(){
    TestListingNavigator.superclass.constructor.apply(this, arguments);
}

Y.extend(TestListingNavigator, Y.lp.app.listing_navigator.ListingNavigator, {
