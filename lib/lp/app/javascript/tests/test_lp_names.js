...
suite.add(new Y.Test.Case({
    ...
    test_start_with_plus_error: function() {
        // Strings starting with a non-alphanumeric character
        // are invalid LP names and thus throw an error.
...
suite.add(new Y.Test.Case({
    ...
    _should: {
        error: {
            ...
            new Error(
                'Passed value "_danilo" is not produced by launchpad_to_css.')
        }
    },
    ...
    test_non_lp_converted_name_error: function() {
        ...
        names.css_to_launchpad('_danilo');
    },
