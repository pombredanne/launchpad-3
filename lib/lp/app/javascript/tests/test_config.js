...
YUI.add('lp.bseconfigutils.test', function(Y) {

var bseconfigutils_test = Y.namespace('lp.bseconfigutils.test');
...
suite.add(new Y.Test.Case({
    ...
    name: 'bseconfigutils_widget_tests',
...
bseconfigutils_test.suite = suite;
