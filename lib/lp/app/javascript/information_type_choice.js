...
YUI.add('lp.app.information_type_choice', function(Y) {

var namespace = Y.namespace('lp.app.information_type_choice');
...
namespace.save_information_type = function(widget, value, lp_client, context) {
        ...
        on: {
            ...
            success: function (id, response) {
                ...
                namespace.information_type_save_success(
                    widget, context, value, null, result_data);
...
namespace.setup_information_type_choice = function(privacy_link, lp_client,
    ...
    information_type_edit.on("save", function(e) {
        ...
        namespace.save_information_type(
            information_type_edit, value, lp_client, context);
    });
