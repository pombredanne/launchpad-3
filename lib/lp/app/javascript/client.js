 ...
 * @class ErrorHandler
 */
var ErrorHandler = function (config) {
    if (Y.Lang.isValue(config)) {
        if (Y.Lang.isValue(config.form)) {
...
ErrorHandler.prototype = {
    ...
    handleFormValidationError: function(error_summary,
        ...
        Y.each(errors, function(message, field_name) {
            ...
            var error_node = Y.Node.create('<div class="message"></div>')
                .setContent(message);
    ...
    getFailureHandler: function () {
        ...
        return function(ioId, o) {
            ...
            // If it was a server error...
                ...
                // If it was a form validation error...
            } else if (o.status === 400
                    && o.statusText === 'Validation') {
                var response_info = Y.JSON.parse(o.responseText);
                ...
                self.handleFormValidationError(
