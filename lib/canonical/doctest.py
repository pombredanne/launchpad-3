# This module is a slightly hacked version of zope/testing/doctest.py
# The single line change is monkey patched into zope.testing.doctest
# by test.py, making our pagetest output nicer until fixes are
# propagated upstream. -- StuartBishop 20041130
    ...
    def output_difference(self, example, got, optionflags):
        ...
        if self._do_a_fancy_diff(want, got, optionflags):
            ...
            if optionflags & REPORT_UDIFF:
                ...
                diff = list(engine.fancy_compare(want_lines, got_lines))
