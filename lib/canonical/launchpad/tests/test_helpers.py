...
def test_person_or_request_languages():
    '''
    ...
    >>> from canonical.launchpad.helpers import person_or_request_languages
    ...
    >>> languages = person_or_request_languages(DummyRequest())
    >>> len(languages)
    1
    >>> languages[0].code
    'es'
