...
ubuntuteam_default = [u'cprov, celso.providelo@canonical.com'
...
ubuntuteam_email = [u'celso.providelo@canonical.com'
...
ubuntuteam_full = [u'ubuntu-team|10|limi|--none--|Alexander Limi|no'
