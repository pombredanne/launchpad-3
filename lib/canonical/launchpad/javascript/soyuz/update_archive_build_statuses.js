...
YUI.add('soyuz.update_archive_build_statuses', function(Y){
    ...
    var build_summary_portlet_dynamic_update_config = {
        ...
        domUpdateFunction: function(portlet_node, data_object){
            var counter_nodelist = portlet_node.queryAll('.build-count');

            // For each node of the counter node in the portlet:
            counter_nodelist.each(function(node){
        ...
        stopUpdatesCheckFunction: function(portlet_node){
            ...
            var pending_elem = portlet_node.query(".pending");
    ...
    Y.on("domready", function(){
        ...
        // update itself:
        var portlet = Y.get('div#build-status-summary');
