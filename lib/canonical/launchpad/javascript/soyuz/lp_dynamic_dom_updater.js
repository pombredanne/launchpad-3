...
var LP = Y.namespace('LP');
    ...
    /*
     * Ensure that the DomUpdater is available within the LP namespace.
     */
    LP.DomUpdater = DomUpdater;
    ...
    Y.extend(DynamicDomUpdater, DomUpdater, {
        ...
        initializer: function(){
            ...
            // XXX mars 20090501 bug=370189
            // Turn this into a timeout, not an interval.  It will update only
            // once, but keeps us from polling the servers too much.
    ...
    /*
     * Ensure that the DynamicDomUpdater is available within the LP
     * namespace.
     */
    LP.DynamicDomUpdater = DynamicDomUpdater;
