...
YUI.add('soyuz.dynamic_dom_updater', function(Y) {
    ...
    LP.DynamicDomUpdater.ATTRS = {
        ...
        /**
         * Update method choice
         *
         * 'API' (default) will use LP API with a optional 'api_method_name',
         * 'XHR' will use a plain XHR call on the specified 'uri'.
         */
        update_method: {
            value: 'API'
        }
    ...
    Y.extend(LP.DynamicDomUpdater, DomUpdater, {
        ...
        dynamicUpdate: function() {
            ...
            var update_method = this.get("update_method");
            ...
            else if (update_method == 'XHR') {
                Y.io(uri, this._lp_api_config);
            }
            else {
                Y.log("Unsupported update method: " + update_method);
            }
