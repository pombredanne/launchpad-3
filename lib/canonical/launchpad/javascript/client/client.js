...
Y.extend(PATCHPlugin, Y.Plugin, {
    ...
    doPATCH: function() {
        ...
        patch_payload[attribute] = this.serialize(owner.getInput());
    ...
    /**
     * Prep the attribute's data for sending.
     *
     * The default implementation just returns the input data unchanged.
     *
     * @method serialize
     * @public
     * @param data {String} The data to serialize.
     * @return {Obj} The new data, transformed into the required type.
     */
