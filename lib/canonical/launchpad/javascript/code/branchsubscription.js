...
function subscribe_yourself_inline(data) {
    ...
    var me = LP.client.links.me;

    /* XXX: rockstar - Select boxes don't pass the data across the way the API
     * is expecting it to come.  This basically means that the data passed into
     * this function is worthless in this situation.
     */
    ...
    config = {
        on: {
            ...
            failure: function(id, response) {
                subscription_form_overlay.showError(response.responseText);
