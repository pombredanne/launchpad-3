 ...
 *
 * @module lp.code.branchmergeproposal.popupdiff
 * @requires node
 */

YUI.add('lp.code.branchmergeproposal.popupdiff', function(Y) {

// Grab the namespace in order to be able to expose the connect method.
var namespace = Y.namespace('lp.code.branchmergeproposal.popupdiff');
