...
Y.extend(SubscriptionWidget, Y.Widget, {
    ...
    initializer: function () {
        ...
        this._updateSubscribersList = function() {
            Y.log('subscriber list update');
            Y.io('+branch-portlet-subscriber-content', {
                on: {
                    success: function(id, response) {
                        Y.get('#branch-subscribers-greater').set(
    ...
    bindUI: function() {
        ...
        //TODO: subscribe a "link up unsubscribe links" to a
        //"subscriber-list-updated" event.
        //TODO: figure out how to green flash.
    },
    syncUI: function() {},
});
