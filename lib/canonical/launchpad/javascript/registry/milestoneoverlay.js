 ...
 *
 * @module Y.registry.milestoneoverlay
 * @requires  dom, node, io-base, lazr.anim, lazr.formoverlay
 */
YUI.add('registry.milestoneoverlay', function(Y) {
    Y.log('loading registry.milestoneoverlay');
    var module = Y.namespace('registry.milestoneoverlay');
