 ...
 *
 * @module Y.registry.milestonetable
 * @requires node, io-base, substitute, lazr.anim
 */
YUI.add('registry.milestonetable', function(Y) {
    Y.log('loading registry.milestonetable');
    var module = Y.namespace('registry.milestonetable');
