...
ProjectLine.prototype = {
    ...
    get_width: function() {
        ...
        for(var i in this.series_lines) {
            ...
            var series_width =
                this.series_lines[i].stop.x + text_beyond_last_landmark;
    ...
    get_height: function() {
        ...
        for(var key in this.series_lines[0].labels) {
            var label = this.series_lines[0].labels[key];
            break;
        }
        if(label === undefined) {
            return 0;
