...
suite.add(new Y.Test.Case({
    ...
    test_zoom_buttons: function() {
        var zoom_in = this.content_box.one('a.yui-timelinegraph-zoom-in');
        Assert.isNotNull(
            zoom_in,
            'zoom_in link not found.');

        var zoom_out = this.content_box.one('a.yui-timelinegraph-zoom-out');
        Assert.isNotNull(
            zoom_in,
...
var handle_complete = function(data) {
    ...
    parent_body.appendChild(status_node);
    };
