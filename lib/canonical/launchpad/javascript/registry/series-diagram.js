...
function draw_graph(timeline, canvas) {
    ...
    var x_end_vertical = x_start_vertical + (series_count * angle_x_spacing);

    var y_end_vertical = 0;
    var y_start_vertical = timeline.lines_of_development.length * y_spacing;

    canvas.width = x_end_vertical + 3 * x_spacing;
    canvas.height = y_start_vertical + y_spacing;
    // Evil global.
    ...
    for(var i in timeline.lines_of_development) {
        ...
        i = parseInt(i);
        var series = timeline.lines_of_development[i];
