 ...
 *
 * @module Y.lp.registry.productseries_setbranch
 * @requires node
 */
YUI.add('lp.registry.productseries_setbranch', function(Y) {
    Y.log('loading lp.registry.productseries_setbranch');
    var module = Y.namespace('lp.registry.productseries_setbranch');
