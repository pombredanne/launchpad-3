...
translations.toggle_languages_visibility = function(e) {
    ...
    if (toggle_button.hasClass('View All Languages')) {
      toggle_button.setContent('');
      toggle_button.removeClass('languages-visible');
    } else {
      toggle_button.setContent('View Only Preferred Languages');
      toggle_button.addClass('languages-visible');
    }
};
