...
Y.Test.Runner.add(new Y.Test.Case({
    ...
    test_activate_collapsibles_doesnt_fail_on_legendless_collapsible:
        ...
        var valid_collapsible = this.container.query('.collapsible');
        ...
        Assert.isNotNull(
            valid_collapsible.query('.collapseWrapper'),
    ...
    test_activate_collapsibles_sets_up_multiple_collapsibles: function() {
        ...
        Y.lp.activate_collapsibles();
        Y.each(Y.all('.collapsible'), function(collapsible) {
            Assert.isNotNull(
                collapsible.query('.collapseWrapper'),
    ...
    test_activate_collapsibles_removes_existing_anchors: function() {
        ...
        var collapsible = this.container.query('.collapsible');
        Assert.isNull(
            this.container.query('#should-be-removed'),
    ...
    test_activate_collapsibles_doesnt_reactivate_collapsibles: function() {
        ...
        Y.lp.activate_collapsibles();
        var collapsible = this.container.query('.collapsible');
        var anchor = collapsible.query('a');
        var span = anchor.query('span');
        var original_span_contents = span.get('innerHTML');
        var wrapper = collapsible.query('.collapseWrapper');
        var original_wrapper_contents = wrapper.get('innerHTML');

        // Calling activate_collapsibles() shouldn't break things.
        Y.lp.activate_collapsibles();
        collapsible = this.container.query('.collapsible');
        anchor = collapsible.query('a');
        span = anchor.query('span');
        wrapper = collapsible.query('.collapseWrapper');
