...
Y.lp.picker.addPickerPatcher = function (
    ...
    var remove = function () {
        ...
        var success_handler = function (e) {
            activator.renderSuccess(Y.Node.create('None'));
            show_hide_buttons();
        };
    ...
    if (show_remove_button) {
        remove_button = Y.Node.create(
            '<button class="yui-picker-remove-button" ' +
            'style="margin-right: 0.2em; ' +
            'background: url(/@@/remove) 0.2em 0 no-repeat">' +
            '<span style="margin-left: 1.3em">' + remove_button_text +
            '</span></button>');
    ...
    if (show_assign_me_button) {
        assign_me_button = Y.Node.create(
            '<button class="yui-picker-assign-me-button" ' +
            'style="background: url(/@@/person) 0.2em 0 no-repeat">' +
