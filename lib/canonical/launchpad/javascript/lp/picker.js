...
Y.lp.picker.addPickerPatcher = function (
    ...
    var delete_icon = content_box.query('.delete-button');
    ...
    delete_icon.on('click', function (e) {
        ...
        var deleteSuccessHandler = function () {
            activator.renderSuccess(Y.Node.create('*deleted*'));
            delete_icon.addClass('yui-activator-hidden');
        };
    ...
    var save = function (picker_result) {
        ...
        var successHandler = function (e) {
            ...
            delete_icon.removeClass('yui-activator-hidden');
        };
...
Y.lp.picker.create = function (vocabulary, save, config) {
    ...
    var search_handler = function (e) {
        ...
        success_handler = function (ignore, response, args) {
