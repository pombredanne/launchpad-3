YUI.add('lp.mapping', function(Y) {
    ...
    /**
     * Add a marker for the first 24 participants, and update the zoom level.
     *
     ...
     * @param {String} div_id the id of the div that controls the map.
     */
    ...
    mapping.renderTeamMapSmall = function(center_lat, center_lng) {
        ...
        gDownloadUrl("+mapdata", function(data) {
            mapping.setMarkersInfoWindowForSmallMap(data, team_map, 24);
            });
    };
