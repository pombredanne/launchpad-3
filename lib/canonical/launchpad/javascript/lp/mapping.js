YUI.add('lp.mapping', function(Y) {
    mapping = Y.namespace('lp.mapping');
    ...
    mapping.setLocation = function(lat, lng, tz_name, lat_name, lng_name) {
        ...
        document.getElementById(lng_name).value = lng;
        ...
        var spinner = document.getElementById('tz_spinner');
        spinner.src = '/@@/spinner';
    ...
    mapping.getSmallMap = function(div_id, center_lat, center_lng) {
        // Note that YUI's Nodes are not compatible with the true DOM nodes
        // used by Google.
