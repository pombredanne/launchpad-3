...
bugs.setup_tag_entry = function() {
    ...
    Y.log("Known official tags: " + available_official_tags, 'info');
    ...
    autocomplete.on('queryChange', function(e) {
        ...
        Y.log("query: " + val, 'info');
    });
    autocomplete.on('visibleChange', function(e) {
        Y.log("visible: " + e.newVal, 'info');
    });
    autocomplete.on('matchesChange', function(e) {
        Y.log("matches: " + e.newVal.length, 'info');
    });
