 ...
 * expander.
 * @param expander The expander for which to return the relevant
 *                     div.
 */
function get_details_div(expander) {
    table_row = expander.get('parentNode').get('parentNode');
...
function collapse_bug_details(expander) {
    bug_details_div = get_details_div(expander);
