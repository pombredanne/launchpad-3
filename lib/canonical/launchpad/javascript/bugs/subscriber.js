...
Y.extend(Subscription, Y.Base, {
     ...
     * user?
     *
     * @method canBeUnsubscribedByUser
     * @return {Boolean}
     */
     ...
     *
     * @method isCurrentUserSubscribing
     * @return {Boolean}
     */
     ...
     *
     * @method hasDuplicateSubscriptions
     * @return {Boolean}
     */
...
Y.extend(Subscriber, Y.Base, {
    ...
    initializer: function(config) {
        ...
        this.setDisplayName();
        this.setTruncatedDisplayName();
    },

    /*
     * Finds the display name using the LP API.
     *
     * @method getDisplayNameFromAPI
     * @param client {Object} An LP API client.
     */
    getDisplayNameFromAPI: function(client) {
        var cfg = {
            on: {
     ...
     * node.
     *
     * @method getDisplayNameFromNode
     */
    getDisplayNameFromNode: function() {
        var user_node;
    ...
    setDisplayName: function() {
        var display_name = this.getDisplayNameFromNode();
        if (display_name !== '') {
            ...
            if (typeof(LP) != 'undefined') {
                ...
                this.getDisplayNameFromAPI(client);
            }
        }
    },
     ...
     *
     * @method setTruncatedDisplayName
     */
    setTruncatedDisplayName: function() {
