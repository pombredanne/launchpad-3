...
function unsubscribe_user_via_icon(icon) {
    ...
    var current_user_unsubscribing = icon_user_name == user_name;
        ...
        on: {
            success: function(client) {
                ...
                if (current_user_unsubscribing) {
                    flash_node = Y.get('#subscriber-' + user_name);
                } else {
                    flash_node = Y.get('#subscriber-' + icon_user_name);
                }
                ...
                anim.on('end', function(e) {
                    if (current_user_unsubscribing) {
                        ...
                        remove_user_name_link(icon_user_name);
                    }
