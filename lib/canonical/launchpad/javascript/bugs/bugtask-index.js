 ...
 * @param can_be_unsubscribed {Boolean} Can the newly added subscrioption be
 ...
 *
 * This is a two step process -- get the list of subscrpitions, then
 * find the current one and check canBeUnsubscribedByUser for how to handle
 * the subscription.
 *
 * @method handle_subscriptions
 * @param someone_else_name {String} The subscribers username.
 * @param someone_else_display_name {String} The subscribers display name.
 ...
 * widget. This is where the work of subscribing someone else
 * actually happens.
 *
