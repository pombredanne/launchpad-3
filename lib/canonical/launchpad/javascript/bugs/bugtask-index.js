...
bugs.setup_me_too = function(user_is_affected) {
    if (user_is_affected === null) {
        // This means that the user has not given any indication if
        // they are or are not affected by this bug. We will pretend
        // this means that they are not affected by this bug.
        user_is_affected = false;
    }
