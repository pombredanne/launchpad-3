...
Y.on('domready', function() {
    ...
    if (privacy_link) {
        ...
        form_load_callbacks[privacy_form_id.id] = createPrivacyFormOverlay;

        privacy_link.on('click', function(e) {
            if (privacy_form_overlay) {
                e.preventDefault();
                privacy_form_overlay.show();
                // Y.get('#field.private') returns null. No idea why...
 ...
 */
var createPrivacyFormOverlay = function(form_content) {
