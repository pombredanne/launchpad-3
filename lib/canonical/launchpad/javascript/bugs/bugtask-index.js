...
Y.on('load', function() {
    ...
    // Handle click events on the unsubscribe minus icon.
...
function subscribe_current_user(subscription_link) {
    ...
    var html = '<div id="subscriber-' + short_name + '">' +
        '<a href="' + me + '" title="Subscribed themselves">' +
          '<img alt="" src="/@@/person" width="14" height="14" />' +
          '&nbsp;' + display_name + '&nbsp;' +
        '</a>' +
        '<a href="+subscribe" id="unsubscribe-' + short_name + '" title="Unsubscribe ' + display_name + '">' +
