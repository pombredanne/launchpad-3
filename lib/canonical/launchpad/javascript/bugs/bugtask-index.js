...
function setup_inline_commenting() {
    ...
    function hide_or_show_submit_button(e) {
        if (comment_input.get('value') === '') {
            save_changes.set('disabled', true);
        }
        else {
            save_changes.set('disabled', false);
        }
    };
    ...
    save_changes.addClass('js-action');
    save_changes.setStyle('display', 'inline');
