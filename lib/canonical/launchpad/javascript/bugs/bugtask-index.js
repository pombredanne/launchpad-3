...
Y.extend(MeTooChoiceSource, Y.ChoiceSource, {
    ...
    syncUI: function() {
        ...
        var flame = content_box.query('img[src=/@@/flame-icon]');
        if (this.get('value')) {
    ...
    render: function() {
        ...
        // Show the alternative edit icon (i.e. the one on the left).
        this.get('contentBox').query('a[class=unseen]').removeClass('unseen');
    },
