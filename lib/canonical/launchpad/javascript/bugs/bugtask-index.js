...
/*
 * A few top-level vars for working with the bug
 * across the module.
*/
var bug_repr;
var me;
...
/*
 * Used to remove and add the user's name from
 * the subscriber's list.  This fixes a bug
 * where the div for the user name does not flash
 * green as it should.
*/
