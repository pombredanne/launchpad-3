...
class ProductSeriesView(LaunchpadView):
    ...
    def processForm(self):
        ...
        if len(dispatch_to) == 0:
            # None of the know forms has been submitted.
            # XXX 20051129  CarlosPerelloMarin: Not sure what to do here with
            # the autogenerated +addrelease form. Steve, any idea?
            return
