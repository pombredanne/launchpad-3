...
from lp.translations.browser.language import *
...
from lp.translations.browser.translationgroup import *
from lp.translations.browser.translationimportqueue import *
from lp.translations.browser.translations import *
from lp.translations.browser.translator import *
