...
class notify_question_modified:
    ...
    modifications are: status, messages, datesolved, answerer, answer,
    ...
    def __call__(self, func):
        ...
        def notify_question_modified(self, *args, **kwargs):
            ...
            for field in ['status', 'datesolved', 'answerer', 'answer',
...
class Question(SQLBase, BugLinkTargetMixin):
    ...
    def _giveAnswer(self, user, answer, datecreated):
        ...
        if self.owner == user:
            self.datesolved = msg.datecreated
            self.answerer = user
