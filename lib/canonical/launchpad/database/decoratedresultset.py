...
class DecoratedResultSet(object):
    ...
    This class also fixes a bug currently in Storms' ResultSet#count
    method (see below)
    """
    ...
    def __init__(self, result_set, result_decorator):
        ...
        @param result_decorator: the method that will individual results will
                                 be passed through before being returned.
        """
    ...
    def __iter__(self, *args, **kwargs):
        ...
        Yields a decorated version of the returned value.
        """
    ...
    def __getitem__(self, *args, **kwargs):
        ...
        Returns the the decorated version of the returned value.
        """
    ...
    def order_by(self, *args, **kwargs):
        ...
        return DecorateResultSet(new_result_set, self.result_decorator)

    def count(self, *args, **kwargs):
        """See `IResultSet`.Decorated to fix bug 217644
