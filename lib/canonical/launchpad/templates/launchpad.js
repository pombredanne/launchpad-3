...
function activateCollapsables(){
	...
	anchor.href = '#';
        if (window.addEventListener) anchor.addEventListener("click",toggleCollapsible,false);
        else if (window.attachEvent) anchor.attachEvent("onclick",toggleCollapsible);
