...
// Checks that a checkbox is set, if it's not, give the focus to it.
function checkCheckBox(checkbox_widget_name) {
    checkbox = document.getElementById(checkbox_widget_name)
    if (!checkbox.checked)
        checkbox.focus()
}
