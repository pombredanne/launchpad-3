...
function popup_window(url, name, width, height) {
    ...
    var div = document.getElementById('popup_div_' + name);
    if (!iframe) {
        iframe = document.createElement('iframe');
        iframe.setAttribute('id','popup_iframe_' + name);
        iframe.setAttribute('name','popup_iframe_' + name);
    ...
    content = document.getElementById('portal-column-content')
    content.onclick = function() { div.style.display = 'none' };
}
