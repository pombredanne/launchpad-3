...
window.lpmenu = new function() {
    ...
    LPMenu.prototype.mouse_over_handler = function(event, el) {
        ...
        if (el.sub) {
            //lognode('submenu already displayed', el);
            ...
            if (current_mouse_out_target == el) {
                //lognode('current_mouse_out_target setting to null',
                //    current_mouse_out_target);
    ...
    LPMenu.prototype.mouse_out_handler = function(event, el) {
        ...
        if (!current_mouse_out_target) {
            //lognode('previous current_mouse_out_target',
            //    current_mouse_out_target);
            current_mouse_out_target = el;
            //lognode('current_mouse_out_target', el);
        };
    ...
    LPMenu.prototype.update_tree = function(movedfrom, movedto) {
        //lognode('updatetree movedfrom', movedfrom);
        //lognode('updatetree movedto', movedto);
        if (movedfrom) {
