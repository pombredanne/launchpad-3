...
window.lpmenu = new function() {
        ...
        current_mouse_over_deferred = MochiKit.Async.callLater(
            ...
            function() {
                try {
                    ...
                    debug('exception in update_tree 1: ' + e.message);
                };
    ...
    LPMenu.prototype.attach = function(parent, sub) {
        ...
        */
        if (current_selected) {
            //removeElementClass(current_selected, 'selected');
        };
        ...
        if (parent && parent.parentNode.parentNode.nodeName == 'LI') {
            if (document.all) {
                ...
                this.subel.style.top = ensure_units(
                    getElementPosition(inneranchor).y - lpmenu.START_POS_Y);
            ...
            this.subel.style.top = ensure_units(lpmenu.START_POS_Y);
            if (this.parent) {
                var inneranchor = this.parent.getElementsByTagName('a')[0];
                this.subel.style.left = ensure_units(
                    getElementPosition(inneranchor).x);
            };
        };
    ...
    LPSubMenu.prototype.start_scroll_down = function(e) {
        ...
        try {
            ...
            debug('error in update tree 2: ' + e.message);
        };
        this.scroll_down();
    };
    ...
    LPSubMenu.prototype.start_scroll_up = function(e) {
        ...
        try {
            ...
            debug('error in update tree 3: ' + e.message);
        };
        this.scroll_up();
    };
