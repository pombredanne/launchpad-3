...
class IQuestion(IHasOwner):
    ...
    datesolved = Datetime(title=_("Date Answered"), required=False,
        description=_(
    ...
    def giveAnswer(user, answer, datecreated=None):
        ...
        datelastresponse and datesolved attributes are updated to the
    ...
    def confirmAnswer(comment, answer=None, datecreated=None):
        ...
        message's owner. The datelastresponse and datesolved attributes are
    ...
    def reject(user, comment, datecreated=None):
        ...
        datesolved are updated to the message creation.
    ...
    def reopen(comment, datecreated=None):
        ...
        method should reset the datesolved, answerer and answer attributes.
