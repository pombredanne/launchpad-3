...
patch_entry_return_type(IBranch, 'addLandingTarget', IBranchMergeProposal)
patch_plain_parameter_type(
    IBranch, 'addLandingTarget', 'target_branch', IBranch)
patch_plain_parameter_type(
    IBranch, 'addLandingTarget', 'prerequisite_branch', IBranch)
