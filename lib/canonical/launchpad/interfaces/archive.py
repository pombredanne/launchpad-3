...
class IArchiveConsoleForm(Interface):
    ...
    include_binaries = Bool(
        title=_("Include binaries"), required=False, default=False,
        description=_("Also act on binaries generated by selected sources"))

    selected_sources = List(
        value_type=Int(title=_("Publishing source ID")), required=False)

    #selected_sources = Int(
    #    title=_("Publishing source ID"))
