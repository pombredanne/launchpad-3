...
class ISourcePackageRelease(Interface):
    ...
    # Joined into our VSourcePackageReleasePublishing view
    name = Attribute("The name of the source package this is a release for")
    shortdesc = Attribute("The short description of the source package "
