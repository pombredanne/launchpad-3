...
class ISourcePackageRelease(Interface):
    ...
    architecturehintlist = TextLine(
        ...
        required=True)
    maintainer_rfc822 = TextLine(
        title=_("Maintainers RFC822 identification"),
        description=_(
        "Original maintainer line contained in the changesfile."),
        required=True)
    standards_version = TextLine(
        title=_("Standards version"),
        description=_(
        "Standards version used to build this source."),
        required=True)
    dsc_format = TextLine(
        title=_("DSC format"),
        description=_(
        ...
        required=True)
    binary_line = TextLine(
        title=_("Proposed binaries"),
        description=_(
    ...
    def getBuildByArch(distroarchrelease):
        ...
        This will look first for published architecture-specific binary
