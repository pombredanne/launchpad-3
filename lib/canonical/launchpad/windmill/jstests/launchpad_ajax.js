...
test_prepopulated_data_anonymous = new SynchronizedTest(
    ...
    function (test) {
        jum.assertUndefined(LP.links.me);
        jum.assertUndefined(LP.cache.context);
    }
    ]);
...
test_logged_in_as_foo_bar.test_prepopulated_data = new SynchronizedTest(
    ...
    function (test) {
        ...
        jum.assertEquals(LP.links.me, '/~name16');

        // If the view has a context, the context will be in the object
        // cache.
        jum.assertNotUndefined(LP.cache.context);
        ...
        jum.assertNotUndefined(LP.cache.bug);
