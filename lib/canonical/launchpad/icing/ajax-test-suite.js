...
function ajax_test_suite() {
    ...
    function entry_callback(entry) {
        ...
        // Get a hosted file and run tests on it.
        var deferred = entry.follow_link('mugshot');
        deferred.addCallback(hosted_file_callback);
        deferred.addErrback(default_errback);
    }
    ...
    function hosted_file_callback(hosted_file) {
        ...
        hosted_file.filename = "test.png";
        hosted_file.contents = "foobar";
        hosted_file.content_type = "image/png";
        var deferred = hosted_file.lp_save();
        deferred.addCallback(modified_hosted_file_callback);
        deferred.addErrback(default_errback);
    }

    function modified_hosted_file_callback(response) {
        alert("Written!");
    }
