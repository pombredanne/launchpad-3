...
function initInlineHelp() {
    /*
      ...
      page elements.
    */
    // Show the actualy button, we don't include it in the page to hide it from lynx
    $('help-close').innerHTML = '<input id="help-close-btn" type="button" value="OK">';
...
function showHelpFor(trigger) {
    ...
    */
    ...
    /* Position the Help Pane in the center of the screen */
