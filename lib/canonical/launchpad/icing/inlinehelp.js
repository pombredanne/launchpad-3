...
function setupHelpTrigger(elem) {
    ...
    */
    //logDebug("Found help link: " + elem.href);
...
function initHelpPane() {
    ...
    */
    ...
    connect('help-pane-content', 'onload', handleHelpLoaded);
    dismissHelp();
}
...
function showHelpFor(trigger) {
    ...
    */
    ...
    // <iframe> at its href.
    //logDebug("Showing help popup for " + trigger.href);

    // Swap in our 'Loading...' content.
    makeInvisible('help-pane-content');
    makeVisible('help-wait');
...
function findBestScreenPos(help_pane, trigger) {
    ...
    */
    ...
    var helppane_dim = new Dimensions(450, 350);
    //logDebug("Using help-pane dimensions: " + helppane_dim);
...
function handleHelpLoaded(event) {
    /*
      ...
      loading.
    */
    makeInvisible('help-wait');
    // We alse have to remove the display:block style.
    hideElement('help-wait');
    makeVisible('help-pane-content');
    //logDebug("Handled popup 'onload' event.")
}
