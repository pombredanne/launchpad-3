...
function popup_window(url, name, width, height) {
    ...
    // The actual JavaScript expression in the src attribute is
    // "void 0;", but the browser translates the space into the html entity
    // "%20".
    if (!iframe.src || iframe.src == 'javascript:void%200;') {
