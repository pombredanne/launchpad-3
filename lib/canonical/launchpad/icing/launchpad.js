...
var PortletManager = {
    ...
    isExpanded: function(portlet_name) {
        return findValue(this.expanded_portlets, portlet_name) >= 0;
    },

    setExpanded: function(portlet_name, is_expanded) {
        var pos = findValue(this.expanded_portlets, portlet_name);
        if (is_expanded) {
            if (pos == -1) {
    ...
    togglePortlet: function(ev) {
        ...
        if (portlet_name) {
            this.setExpanded(portlet_name, is_expanded);
        }
    },
