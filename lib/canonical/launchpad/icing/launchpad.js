...
function popup_window(url, name, width, height) {
    ...
    // IE treats 'src="javascript:false"' as the value false, but
    // other browsers treat it as a string, so we check for both.
    if (!iframe.src || iframe.src == 'javascript:false') {
