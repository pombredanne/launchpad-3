...
var PortletManager = {
    ...
    writeCookie: function() {
        ...
        // XXX: 20070718 jamesh
        // Should we set an expiry on this cookie?  Without it, we end up
        // with a cookie that only lasts the session.
        document.cookie = 'expanded_portlets=' + value + this.cookie_scope;
    },

    isExpanded: function(portlet_id) {
        return findValue(this.expanded_portlets, portlet_id) >= 0;
    },

    setExpanded: function(portlet_id, is_expanded) {
    ...
    togglePortlet: function(ev) {
        ...
        if (portlet_id) {
            this.setExpanded(portlet_id, is_expanded);
        }
    },
    ...
    initialize: function(cookie_scope) {
        ...
        for (var i = 0; i < portlets.length; i++) {
            ...
            if (portlet_id && this.isExpanded(portlet_id)) {
