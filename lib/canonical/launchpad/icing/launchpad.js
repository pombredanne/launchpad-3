...
function activateCollapsables() {
    ...
    for (var i = 0; i < collapsibles.length; i++) {
        ...
        if (collapsibles[i].className.indexOf('collapsed') != -1 ) {
            ...
            hiderWrapper.setAttribute('class', 'collapsed');
            // Remove "collapsed" from the fieldset to neuter the main CSS:
            collapsibles[i].setAttribute('class', 'collapsible');
        }
...
function toggleCollapsible(e) {
    ...
    // walk up the node hierarchy til we find the <legend> element
    ...
    if (icon.getAttribute('src').indexOf(
        ...
        icon.setAttribute('src','/@@/treeExpanded');
        legend.parentNode.lastChild.setAttribute('class', 'expanded');
        legend.parentNode.childNodes[1].setAttribute('class', 'collapsed');
    } else {
        icon.setAttribute('src','/@@/treeCollapsed');
        legend.parentNode.lastChild.setAttribute('class', 'collapsed');
        legend.parentNode.childNodes[1].setAttribute('class', 'expanded');
    }
