...
class BzrSyncTestCase(TestCaseWithTransport):
    ...
    def makeBzrSync(self, db_branch, bzr_branch_url):
...
class TestBzrSyncPerformance(BzrSyncTestCase):
    ...
    def makeBzrSync(self, db_branch, bzr_branch_url):
        bzrsync = BzrSyncTestCase.makeBzrSync(self, db_branch, bzr_branch_url)
...
class TestBzrSyncEmail(BzrSyncTestCase):
    ...
    def test_email_format(self):
        ...
        self.commitRevision(rev_id=second_revision,
                            ...
                            timezone=0)
        sync = self.makeBzrSync(self.db_branch, self.bzr_branch_url)
