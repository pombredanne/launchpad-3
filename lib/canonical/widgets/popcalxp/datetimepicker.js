...
var gcCalBG="#afdb19";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#afdb19";	// the background color of the inner table, showing as a frame.
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='/@@/arrowLeft' width='14' height='14' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='/@@/arrowRight' width='14' height='14' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
