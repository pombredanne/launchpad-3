# Copy of this module from Twisted SVN -- we need features that aren't in the
# 1.3.0 release.
# This is r11600 of the file found at twisted/enterprise/adbapi.py (except for
# this message and one commented-out import), and is licensed under an MIT-style
# license.
#    - Andrew Bennetts, 2004-10-08
