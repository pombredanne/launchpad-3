...
class Version(unittest.TestCase):
    ...
    def testNotEmpty(self):
        ...
        from sourcerer.deb.version import Version, BadInputError
        self.assertRaises(BadInputError, Version, "")

    def testEpochNotEmpty(self):
        """Version should fail with empty epoch."""
        from sourcerer.deb.version import Version, BadEpochError
    ...
    def testRevisionNotEmpty(self):
        ...
        from sourcerer.deb.version import Version, BadRevisionError
...
class Strcut(unittest.TestCase):
    def testNoMatch(self):
        ...
        from sourcerer.deb.version import strcut
...
class DebOrder(unittest.TestCase):
    ...
    def testTilde(self):
        ...
        from sourcerer.deb.version import deb_order
...
class DebCmpStr(unittest.TestCase):
    ...
    def testEmptyStrings(self):
        ...
        from sourcerer.deb.version import deb_cmp_str
