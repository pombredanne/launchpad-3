...
var gsInnerTable="border=0 cellpadding=0 cellspacing=1";	// HTML tag properties of the inner <table> tag, which holds all the calendar cells.
...
var gsNavPrev="<img src='/@@/arrowLeft' height='14' width='14' id='navPrev' class='MonthNav' onmouseover='this.style.backgroundColor=\"#c8ef48\"' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();this.style.backgroundColor=\"#afdb1f\";if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<img src='/@@/arrowRight' height='14' width='14' id='navNext' class='MonthNav' onmouseover='this.style.backgroundColor=\"#c8ef48\"' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();this.style.backgroundColor=\"#afdb1f\";if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var giCellWidth=26;	// calendar cell width;
var giCellHeight=22;	// calendar cell height;
...
var gcSat="#555";	// Saturday font color
var gcSatBG="";	// Saturday background color
var gcSun="#555";	// Sunday font color
var gcSunBG="";	// Sunday background color
...
var _lineThru=false; // Do not strikeout the inaccessible dates. We will theme them differently using agenda.js

var gbFocus=true;	// whether to enable the gcToggle highlight whenever mouse pointer focuses over a calendar cell.
var gcToggle="";	// the highlight color for the focused cell

var gcFGToday="darkred";	// the font color for today 
var gcBGToday="#ededed";	// the background color for today 
var guTodayBGImg="";	// url of image as today's background
var giMarkToday=1+2+8; // Effects for today - 0: nothing; 1: set background color with gcBGToday; 2: draw a box with gcBGToday; 4: bold the font; 8: set font color with gcFGToday; 16: set background image with guTodayBGImg; - they can be added up to create mixed effects.
var gsTodayTip="Today";	// tooltip for today

var gcFGSelected="black";	// the font color for the selected date
var gcBGSelected="#fcfc99";	// the background color for the selected date
var guSelectedBGImg="";	// url of image as background of the selected date
var giMarkSelected=11;	// Effects for selected date - 0: nothing; 1: set background color with gcBGSelected; 2: draw a box with gcBGSelected; 4: bold the font; 8: set font color with gcFGSelected; 16: set background image with guSelectedBGImg; - they can be added up to create mixed effects.
