...
COMMENT ON COLUMN Archive.old_binary_retention_days IS 'The number of days before superseded or deleted binary files are expired in the librarian, or zero for never.';
