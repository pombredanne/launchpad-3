...
COMMENT ON COLUMN UserToUserEmail.sender_id IS 'The person sending this email.';
COMMENT ON COLUMN UserToUserEmail.recipient_id IS 'The person receiving this email.';
