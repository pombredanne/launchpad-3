...
COMMENT ON COLUMN Milestone.distrorelease IS 'The distrorelease for which this is a milestone.';
COMMENT ON COLUMN Milestone.productseries IS 'The productseries for which this is a milestone.';
