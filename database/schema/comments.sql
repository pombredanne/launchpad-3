...
COMMENT ON COLUMN DistributionSourcePackage.is_meta IS 'Whether it is meta distributionsourcepackage, which means that it should not be linked to an upstream project.';
