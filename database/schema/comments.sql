...
COMMENT ON COLUMN SourcePackageRelease.changelog IS 'The changelog assoicated with this source package. It is required for all source packages and can be found after installation at /usr/share/doc/<binarypackagename>/copyright.gz';
