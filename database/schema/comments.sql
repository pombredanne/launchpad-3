...
COMMENT ON COLUMN HWSubmission.status IS 'The status of the submission. See HWSubmissionStatus for valid values.';
COMMENT ON COLUMN HWSubmission.private IS 'If True, the submitter allows public access to the data. If false, the data may be used only for statistical purposes.';
