...
-- RelicensingTranslations
COMMENT ON TABLE RelicensingTranslations IS 'Who of translation contributors wants their translations relicensed and who does not.';
COMMENT ON COLUMN RelicensingTranslations.person IS 'A translator which has submitted their answer.';
COMMENT ON COLUMN RelicensingTranslations.allow_relicensing IS 'Does this person want their translations relicensed under BSD.';
COMMENT ON COLUMN RelicensingTranslations.date_decided IS 'Date when the last change of opinion was registered.';
