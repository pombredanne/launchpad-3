...
COMMENT ON COLUMN BugNotification.is_omitted IS 'Was this notification omitted when emails were sent?  Ignore if date_emailed is not yet set.  Only intended to be useful for debugging purposes.';
