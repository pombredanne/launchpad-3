...
-- For each bug report that has Web links, append a blank line to the description
-- and then the title and URL of each bug link.
...
-- Once all the Web links are migrated, clean up, and abolish the Web links table.
