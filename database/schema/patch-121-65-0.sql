...
-- Index needed for librarian garbage collection
CREATE INDEX build__upload_log__idx ON Build (upload_log)
...
INSERT INTO LaunchpadDatabaseRevision VALUES (121, 65, 0);
